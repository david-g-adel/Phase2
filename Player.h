...
class Player
{
	...
	int stopped; //number of turns player cant play
public:
	...
	void setstopped(int s);
	int getstopped();
	void MoveToCell(Grid* pGrid, CellPosition C);
	void SetStepCount(Cell* pCell);
	int GetStepCount();
	void Restart(Grid*pGrid);
	int GetPlayerNum();
};
